    ...
    return loader.loads("""[
        {
           "target" : "/pa/units/land/tank_armor/tank_armor.json",
            "patch" : [
                {"op" : "replace", "path" : "/events/fired/effect_spec", "value" : "/mod/com.pac.domdom.laser_unit_effects/inferno/spark_muzzle_flash.pfx socket_muzzle"}
            ]
        },        
        {
            "target" : "/pa/units/land/tank_armor/tank_armor_muzzle_flame.pfx",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/inferno/spark_muzzle_flash.pfx",
            "patch" : """ + muzzle_patch + """
        },
        {
            "target" : "/blueflamethrower.papa",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/blueflamethrower.papa"
        },
        {
            "target" : "/pa/units/land/tank_armor/tank_armor_muzzle_flame.pfx",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/inferno/spark_muzzle_flash.pfx",
            "patch" : [
                ...
                {"op" : "replace", "path" : "/emitters/1/spec/baseTexture", "value" : "/mod/com.pac.domdom.laser_unit_effects/blueflamethrower.papa"}
            ]
        }
    ]""")