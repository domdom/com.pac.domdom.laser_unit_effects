    ...
    return loader.loads("""[
        {
           "target" : "/pa/units/commanders/base_commander/base_commander.json",
            "patch" : [
                {"op" : "add", "path" : "/events/fired", "value" : {"effect_spec" : "/mod/com.pac.domdom.laser_unit_effects/commander/commander_muzzle_flash.pfx socket_rightMuzzle"}}
            ]
        },
        {
            "target": "/pa/effects/specs/tank_muzzle_flash.pfx",
            "destination": "/mod/com.pac.domdom.laser_unit_effects/commander/commander_muzzle_flash.pfx",
            "patch": [
        ...
        },
        {
            ...
            "patch" : [
                {"op" : "add", "path" : "/fx_trail", "value" : {"filename" : "/mod/com.pac.domdom.laser_unit_effects/commander/bullet_trail.pfx"}},
                {"op" : "add", "path" : "/events/died", "value" : {}},
                {"op" : "add", "path" : "/events/died/effect_spec", "value" : "/mod/com.pac.domdom.laser_unit_effects/commander/proj_hit.pfx"},
        ...
        },
        {
            ...
            "patch" : [
                {"op" : "add", "path" : "/fx_trail", "value" : {"filename" : "/mod/com.pac.domdom.laser_unit_effects/commander/laser_trail.pfx"}},
                {"op" : "add", "path" : "/events/died/effect_spec", "value" : "/mod/com.pac.domdom.laser_unit_effects/commander/proj_hit.pfx"},
                {"op" : "add", "path" : "/events/died/effect_scale", "value" : 0.15}
            ]
        },
        {
            ...
            "patch" : [
                {"op" : "add", "path" : "/fx_trail", "value" : {
                    "filename" : "/mod/com.pac.domdom.laser_unit_effects/commander/rocket_trail.pfx",
                    "offset": [0.0, 0.9, 0.0]
                }},
                {"op" : "add", "path" : "/events/died/effect_spec", "value" : "/mod/com.pac.domdom.laser_unit_effects/commander/proj_hit.pfx"},
                {"op" : "add", "path" : "/events/died/effect_scale", "value" : 0.15}
        ...
        },
        {
            ...
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/commander/bullet_trail.pfx"
        },
        {
            "target" : "laser_trail.pfx",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/commander/laser_trail.pfx"
        },
        {
            "target" : "rocket_trail.pfx",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/commander/rocket_trail.pfx"
        },
        {
            "target" : "/base_arty/base_ammo_hit.pfx",
            "destination" : "/mod/com.pac.domdom.laser_unit_effects/commander/proj_hit.pfx",
            "patch" : [
